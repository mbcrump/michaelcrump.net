  ...
  <xsl:template match="/">
    <html lang="en">
      <head>
        ...
        <title>RSS — Michael Crump · Signal preview</title>
        <link rel="stylesheet" href="style.css?v=20260722-3"/>
        <link rel="stylesheet" href="pages.css?v=20260722-1"/>
      </head>
      <body>
        ...
        <main id="content" class="shell feed-page">
          ...
          <div class="feed-empty"><p>No new posts have been published yet.</p></div>
